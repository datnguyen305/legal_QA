...
python3 scripts/train_cpg.py --train-data "$TRAIN_DATA" --dev-data "$DEV_DATA" --context-dir "$CONTEXT_DIR" --output-dir models/cpg $(limit_args train-limit "$TRAIN_LIMIT") $(limit_args dev-limit "$DEV_LIMIT")

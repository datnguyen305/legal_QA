...
SEQ2SEQ_GRAD_ACCUM_STEPS=${SEQ2SEQ_GRAD_ACCUM_STEPS:-1}
...
SEQ2SEQ_NUM_BEAMS=${SEQ2SEQ_NUM_BEAMS:-4}
SEQ2SEQ_TEST_BATCH_SIZE=${SEQ2SEQ_TEST_BATCH_SIZE:-8}
SEQ2SEQ_DEV_GENERATE_BATCH_SIZE=${SEQ2SEQ_DEV_GENERATE_BATCH_SIZE:-}

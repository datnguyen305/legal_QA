...
BM25_RETRIEVER=${BM25_RETRIEVER:-bm25}
BM25_BACKEND=${BM25_BACKEND:-pyserini}
BM25_PYSERINI_THREADS=${BM25_PYSERINI_THREADS:-4}
...
python3 "$REPO_ROOT/scripts/bm25_retrieval.py" \
  ...
  --pyserini-threads "$BM25_PYSERINI_THREADS" \
  --top-k "$BM25_TOP_K" \
